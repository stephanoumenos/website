...
Output:
  - public/data/agriculture_animal_ch_10m.geojson  (grassland, pastures, meadows → orange)
  - public/data/agriculture_plant_ch_10m.geojson   (arable crops → yellow)
...
MIN_AREA = 500  # m² — keep all polygons (0 = lossless)
...
EXTRACTIONS = [
    {
        ...
        "output": DATA_DIR / "agriculture_animal_ch_10m.geojson",
        "filter": lambda code: code in ANIMAL_AG_CODES,
    },
    {
        "name": "plant agriculture (arable/crops)",
        "output": DATA_DIR / "agriculture_plant_ch_10m.geojson",
